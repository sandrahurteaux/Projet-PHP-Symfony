...
use LEM_projet2\AdminBundle\Entity\Orders;
use LEM_projet2\AdminBundle\Form\OrdersType;
...
class OrdersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:Orders')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminBundle:Orders:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:Orders')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdminBundle:Orders:edit.html.twig")
     */
