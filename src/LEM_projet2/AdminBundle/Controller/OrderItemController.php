...
use LEM_projet2\AdminBundle\Entity\OrderItem;
use LEM_projet2\AdminBundle\Form\OrderItemType;
...
class OrderItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdminBundle:OrderItem')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminBundle:OrderItem:new.html.twig")
     */
    ...
    /**
    * Creates a form to create a OrderItem entity.
    *
    * @param OrderItem $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createCreateForm(OrderItem $entity)
    {
        $form = $this->createForm(new OrderItemType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdminBundle:OrderItem')->find($id);
    ...
    /**
    * Creates a form to edit a OrderItem entity.
    *
    * @param OrderItem $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(OrderItem $entity)
    {
        $form = $this->createForm(new OrderItemType(), $entity, array(
     ...
     * @Method("PUT")
     * @Template("AdminBundle:OrderItem:edit.html.twig")
     */
