...
/* AdminBundle:StateOrder:index.html.twig */
class __TwigTemplate_e59968eea949325526cc8cc90b7dcb9b21f1142e77a1badc2a80c72fc066190c extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-md-12\">
            <h1>Liste des états de commande</h1>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "                    <tr>
                        <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_stateorder_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
        ...
        echo "                </tbody>
                ...
                <li>
                    <a href=\"";
        // line 39
        echo $this->env->getExtension('routing')->getPath("admin_stateorder_new");
...
";
    ...
    {
        return "AdminBundle:StateOrder:index.html.twig";
    }
